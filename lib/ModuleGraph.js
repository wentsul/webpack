...
class ExportsInfo {
	...
	setHasProvideInfo() {
		for (const exportInfo of this._exports.values()) {
			...
			if (exportInfo.canMangle === undefined && exportInfo.used !== undefined) {
		...
		if (
			this._otherExportsInfo.canMangle === undefined &&
			this._otherExportsInfo.used !== undefined
		) {
	...
	setHasUseInfo() {
		for (const exportInfo of this._exports.values()) {
			...
			if (
				exportInfo.canMangle === undefined &&
				exportInfo.provided !== undefined
			) {
				exportInfo.canMangle = true;
			}
		}
		...
		if (
			this._otherExportsInfo.canMangle === undefined &&
			this._otherExportsInfo.provided !== undefined
		) {
			this._otherExportsInfo.canMangle = true;
		}
...
class ExportInfo {
	...
	constructor(name, initFrom) {
		 ...
		 */
		this.canMangle = initFrom ? initFrom.canMangle : undefined; // TODO split this in canMangleProvided and canMangleUsed
		/** @type {ExportsInfo | null} */
		this.exports = null;
	}
